...
export async function uploadMockData() {
  const data = {
    ...
    "applicationResponses": [{ "id": "response-sample-001", "userId": "SXzRpAtLlgCngTmvfaYCXlZYgyDn", "applicationFormId": "sample-form", "applicationResponseId": "response-sample-001", "rolesApplied": ["engineer", "designer"], "sectionResponses": [{ "sectionName": "Section 1", "questions": [{ "questionType": "short-answer", "applicationFormId": "sample-form", "questionId": "q1", "response": "This is my answer to the short question." }, { "questionType": "long-answer", "applicationFormId": "sample-form", "questionId": "q2", "response": "This is a long-form response that has more than one hundred words. Imagine this goes on and meets the minimum and maximum word count requirements." }, { "questionType": "multiple-select", "applicationFormId": "sample-form", "questionId": "q3", "response": ["Option 1", "Option 3"] }] }], "status": "in-progress", "dateSubmitted": "", "decisionLetterId": "" }],
  }
