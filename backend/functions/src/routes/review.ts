...
router.post("/review", [isAuthenticated, validateSchema(reviewSchema,)], async (req: Request, res: Response) => {
...
router.put("/review/:id", [isAuthenticated, validateSchema(updateReviewSchema)], async (req: Request, res: Response) => {
...
router.delete( "/review/:id", [isAuthenticated], async (req: Request, res: Response) => {
    const reviewId = req.params.id;
