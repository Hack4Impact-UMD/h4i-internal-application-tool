...
const PrivilegedAccessModal: React.FC = () => {
    ...
    return(
        <dialog ref={dialogRef} open className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-0 border-none bg-transparent">
            <main className="flex flex-row h-[50vh] w-[50vw] rounded-xl bg-[#D9D9D9]">
                <div className="text-xl text-[#4E4D4D] ml-3 mt-3 cursor-pointer" onClick={closeDialog}>
                    &larr; Exit 
                </div>
                ...
                <div className="flex flex-col justify-center items-center h-[85%] w-[75%] text-[#4E4D4D] ml-6 mt-9">
                    ...
                    <span className="text-xl font-medium mt-4">Only users with Privileged Access can modify applicant statuses.</span>
