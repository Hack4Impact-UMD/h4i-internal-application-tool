...
export default function FileUpload(props: FileUploadProps) {
  ...
  return (
    <div>
      ...
      {props.errorMessage && <p className="text-red-600">{props.errorMessage}</p>}
    </div>
  );
}
