                ...
                <Button
                  ...
                  onClick={async () => {
                    if (user?.email) {
                      ...
                      throwSuccessToast("Password reset link sent to " + user.email);
                    } else {
                ...
                <Button
                  ...
                  onClick={async () => {
                    if (
                      ...
                      throwErrorToast("Please fill in all required fields before saving.",);
                      return;
                    }
                    
                    if(!validEmail(profileInputData.email)) {
                      throwErrorToast("Invalid Email. Please ensure your email ends with @terpmail.umd.edu or @umd.edu");
                      return;
                    }
                    ...
                    try {
                      ...
                      throwErrorToast("Failed to update profile. Please try again.");
                      console.error(error);
                    }
                  }}
                >
