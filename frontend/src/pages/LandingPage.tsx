    ...
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex flex-col flex-1 items-center justify-center gap-5">
        ...
        />
          <div className="flex flex-col items-center text-center justify-around">
            <h1 className="text-3xl font-bold">Hack4Impact-UMD Application Portal</h1>
            <h3 className="text-lg text-darkgray">{user ? "Welcome back!" : "Apply to be a Hack4Impact-UMD member!"}</h3>
          </div>
          <div>
            {user ?
              <div className="flex flex-row gap-1">
                <Button onClick={() => navigate("/login")}>Enter {displayUserRoleName(user?.role)} Home</Button> 
      ...
      <footer className="py-4 text-center text-md">
        <div className="flex justify-center gap-5 text-gray-600">
          ...
          <Link to="https://www.linkedin.com/company/hack4impact-umd" target="_blank">
            <Linkedin />
          </Link> |
