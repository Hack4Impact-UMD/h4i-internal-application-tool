    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 text-center p-4">
      ...
      {(error instanceof Error) && ( 
        <>
          ...
          <p className="text-md text-muted-foreground mt-2 mb-8 mx-28">{error.stack}</p>
        </>
      )}
      <Link
        to="/"
