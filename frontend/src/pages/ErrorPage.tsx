...
export default function ErrorPage(props: ErrorPageProps) {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 text-center p-4">
      ...
      <p className="text-2xl mt-4 text-gray-600">{errorCodeToMeaning[props.errorCode]}</p>
      <p className="text-md text-muted-foreground mt-2 mb-8">{props.errorDescription}</p>
      <Link
        to="/"
